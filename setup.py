...
setup(
    ...
    name='py-csv-generator',  # Required
    ...
    description='Python project for generating CSV with fake data',  # Required
    ...
    url='https://github.com/yohayg/python-generator',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='yohayg',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='yohayg@gmail.com',  # Optional
    ...
    keywords='utilities generate csv mock fake data',  # Optional
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/yohayg/python-generator/issues',
